...
INSERT INTO grosso_store.users_tbl (user_firstname, user_lastname, user_email, user_password)
VALUES (UPPER('nombres'), UPPER('apellidos'), 'bgrosso@xd.com',AES_ENCRYPT
('password', '$2a$12$ddqbWgqCoTtTSrc.QXz97OBVXQswzDwrGLbnEE/aa0JD8s58JnJSi'));
INSERT INTO grosso_store.users_tbl (user_firstname, user_lastname, user_email, user_password)
VALUES (UPPER('Brayan'), UPPER('GrOsSo'), 'bgrosso@xd.com',AES_ENCRYPT
